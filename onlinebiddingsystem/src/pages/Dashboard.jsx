            ...
            <div key={index} className="col-sm-6 col-md-4 col-lg-4 gx-5 mb-4 mt-4">
              <div className="card h-100">
                <div className="card-body">
                  ...
                  <hr />
                  <button className='btn btn-dark' style={{ backgroundColor: '#3C3C43' }} onClick={handleClick}>Start Bid</button>
                </div>
              </div>
            </div>
          ))}
          <button className='btn btn-dark text-light rounded-pill position-fixed floating-button' style={{ backgroundColor: '#3C3C43', width: '10rem', height: '3rem', bottom: '20px', right: '80px' }} onClick={handleNavigate}> Create Auction</button>
        </div>
      </div>
